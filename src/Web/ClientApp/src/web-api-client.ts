...
export class DashboardClient {
     ...
     * @return OK
     */
    getDashboard(): Promise<DashboardVm> {
    ...
    protected processGetDashboard(response: Response): Promise<DashboardVm> {
        ...
        if (status === 200) {
            ...
            result200 = DashboardVm.fromJS(resultData200);
            return result200;
            });
        } else if (status === 400) {
            return response.text().then((_responseText) => {
        ...
        return Promise.resolve<DashboardVm>(null as any);
    }

    /**
     * Get Job Application Count By Date
     * @return OK
     */
    getJobApplicationCountByDate(date: Date): Promise<number> {
        let url_ = this.baseUrl + "/api/Dashboard/job-application-count-by-date?";
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetJobApplicationCountByDate(_response);
        });
    }

    protected processGetJobApplicationCountByDate(response: Response): Promise<number> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    /**
     * Get Job Applications Per Day
     * @return OK
     */
    getJobApplicationsPerDay(from: Date): Promise<JobApplicationCountPerDayDto[]> {
        let url_ = this.baseUrl + "/api/Dashboard/job-applications-per-day?";
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processGetJobApplicationsPerDay(_response);
        });
    }

    protected processGetJobApplicationsPerDay(response: Response): Promise<JobApplicationCountPerDayDto[]> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200!.push(JobApplicationCountPerDayDto.fromJS(item));
            }
            else {
...
export class DashboardVm implements IDashboardVm {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.totalJobApplications = _data["totalJobApplications"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["totalJobApplications"] = this.totalJobApplications;
        return data;
    }
}
...
export class JobApplicationCountPerDayDto implements IJobApplicationCountPerDayDto {
    date?: Date;
    count?: number;

    [key: string]: any;

    constructor(data?: IJobApplicationCountPerDayDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): JobApplicationCountPerDayDto {
        data = typeof data === 'object' ? data : {};
        let result = new JobApplicationCountPerDayDto();
        result.init(data);
        return result;
    }
...
export interface IJobApplicationCountPerDayDto {
    date?: Date;
    count?: number;
