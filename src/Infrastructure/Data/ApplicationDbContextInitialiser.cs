    ...
    public async Task TrySeedAsync()
    {
        ...
        if (!_context.JobApplications.Any())
        {
            _context.JobApplications.AddRange(
                ...
                new JobApplication { RoleName = "Agile Delivery Manager", CompanyName = "Triad Group", RoleType = RoleType.Permanent, Status = Status.Closed, ProcessStatus = ProcessStatus.Rejected, Source = Source.JobBoard, AdvertisedSalary = "Unknown", Url = "Lon", Commute = Commute.Hybrid, ApplicationDate = new DateTime(2024, 4, 2) },
