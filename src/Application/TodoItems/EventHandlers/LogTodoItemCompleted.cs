using Sumployable.Domain.Events;
using Microsoft.Extensions.Logging;

namespace Sumployable.Application.TodoItems.EventHandlers;
...
public class LogTodoItemCompleted : INotificationHandler<TodoItemCompletedEvent>
{
    ...
    {
        _logger.LogInformation("Sumployable Domain Event: {DomainEvent}", notification.GetType().Name);
